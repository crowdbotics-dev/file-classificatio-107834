...
## Project Structure
    ...
    ├── file_classificatio_107834  # Django project configurations
...
1. Clone this repo and `cd file_classificatio_107834`
...
2. Clone this repo and `cd file_classificatio_107834`
